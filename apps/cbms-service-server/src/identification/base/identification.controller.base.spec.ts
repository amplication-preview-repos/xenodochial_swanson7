...
const service = {
  ...
  identifications: () => FIND_MANY_RESULT,
  identification: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("Identification", () => {
  ...
  test("POST /identifications", async () => {
  ...
  test("GET /identifications", async () => {
    await request(app.getHttpServer())
      .get("/identifications")
  ...
  test("GET /identifications/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/identifications"}/${nonExistingId}`)
  ...
  test("GET /identifications/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/identifications"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /identifications existing resource", async () => {
